...
```{r}
df_birth <- read_csv("data/raw/birth.csv")
df_employment <- read_csv("data/raw/employment.csv")
df_epf_contribution_rates <- read_csv("data/raw/epf contribution rates.csv")
df_epf_savings <- read_csv("data/raw/epf savings.csv")
df_population <- read_csv("data/raw/population.csv")
df_wage <- read_csv("data/raw/wage.csv")
```
...
```{r}
household_income <-  read_csv("data/raw/hh_income.csv")
df_epf_data <-  read_csv("data/raw/epf data.csv")
df_gdp_growth <- read_csv("data/raw/gdp growth.csv")
df_inflation <- read_csv("data/raw/inflation.csv", skip = 4)
df_male_mortality <- read_csv("data/raw/male mortality.csv", skip = 4)
df_female_mortality <- read_csv("data/raw/female mortality.csv", skip = 4)
df_fertility <- read_csv("data/raw/fertility.csv", skip = 4)
```
...
```{r}
# Define file path
file_path <- "data/processed/synthetic_income_data.csv"
...
```{r}
# Define file path
file_path <- "data/processed/final_wage.csv"
...
```{r}
df_income <- read_csv("data/processed/synthetic_income_data.csv")
